...
- [ ] Debloat.
- [ ] Currently communicates in both HTTP requests and MQTT, standardise to just one (probably to HTTP and open the door or not based on the response code).
- [ ] Add error handling and reporting (maybe with leds?).
- [ ] Clean functions with no side effects.
